...
(function() {
	...
	if (!n) {
		...
		m(function() {
			if (!x() &&
				document.querySelectorAll("input[animate__fadeInUp]").length) {
				var a = function() {
				...
				document.querySelectorAll("input[animate__fadeInUp]").forEach(function(a) {
					a.remove()
				});
...
! function() {
	...
	if (!document.getElementById("top-1")) {
		...
		a.id = "top-1";
		a.style = "display: none";
		a.innerHTML = '<a href="https://mobirise.com/builder/no-code-website-builder.html">no coding website builder</a> Mobirise v5.7.4 <a href="https://mobirise.com/extensions/shopping-cart/">paypal cart</a>';
